...
if not exist "%PYTHON_DIR%"\ (
	...
	echo --------------------------------------------------
	echo Executing: %CURL_CMD% -o python.zip https://www.python.org/ftp/python/3.12.7/python-3.12.7-embed-amd64.zip
	%CURL_CMD% -o python.zip https://www.python.org/ftp/python/3.12.7/python-3.12.7-embed-amd64.zip
